...
public class Img {
     ...
     * @return
     */
    public static BufferedImage getImg(int[][][] rgbmat) {
     ...
     * @return JPanel图片
     */
    public static JPanel showImg(final BufferedImage bimg) {
    ...
    static private JFrame imgFrame0(String fnm) {
        //读取图片
    ...
    static public void show(String filePath) {
        imgFrame0(filePath);
    }
}